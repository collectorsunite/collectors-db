...
import ArtModal from '../animalModals/modalArt';
...
export default class ArtPage extends Component {
  ...
  render() {
    ...
    return (   
        ...
        <small className="h2title_heading">Art</small>
        <div>
                  ...
                  <tbody>
                      {
                         Object.entries(data).map(([key,value])=>
                              <tr>
                                  ...
                                  <td className="table_content">{value["buy-price"]}</td> 
                                  <td className="table_content">{<ArtModal  card={value}/>}</td>                                                                                              
                              </tr>
                          )
                      }
                  </tbody>
