...
import FossilModal from '../animalModals/modalFossil';

export default class FossilPage extends Component {
  ...
  fetchData(state, instance) {
    var self = this;
    const url = "https://acnhapi.com/v1/fossils"
  ...
  render() {
    ...
    return (   
        ...
        <small className="h2title_heading">Fossils</small>
        <div>
                  ...
                  <tbody>
                      {
                         Object.entries(data).map(([key,value])=>
                              <tr>
                                  ...
                                  <td className="table_content">{value.price}</td> 
                                  <td className="table_content">{<FossilModal  card={value}/>}</td>                                                                                              
                              </tr>
                          )
                      }
                  </tbody>
