...
import SeaModal from '../animalModals/modalSea';
...
export default class SeaPage extends Component {
  ...
  fetchData(state, instance) {
    var self = this;
    const url = "https://acnhapi.com/v1/sea"
  ...
  render() {
    ...
    return (   
        ...
        <small className="h2title_heading">Sea</small>
        <div>
              <Table hover responsive flexi>
                  <thead>
                  <tr>                      
                      <th className="table_heading">Name</th>
                      <th className="table_heading">Speed</th>
                  ...
                  <tbody>
                      {
                         Object.entries(data).map(([key,value])=>
                              <tr>
                                  ...
                                  <td className="table_content">{value.speed}</td> 
                                  <td className="table_content">{<SeaModal  card={value}/>}</td>                                                                                              
                              </tr>
                          )
                      }
                  </tbody>
